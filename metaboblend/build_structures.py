...
def annotate_msn(ms_data: Dict[str, Dict[str, Union[int, list]]],
...
def build_msn(mc, exact_mass, prescribed_masses, max_n_substructures, smi_out_dir, path_connectivity_db,
              ...
              write_fragment_smis):
    """
    Additional considerations for building from MS/MS data. Extends :py:meth:`metaboblend.build_structures.build` and
    is called by :py:meth:`metaboblend.build_structures.annotate_msn`.
    ...
    :param prescribed_masses: A list of the neutral masses generated at a higher order MSn level for prediction of the
        structure with the supplied mc/exact_mass (MSn-1).
    ...
    :param path_connectivity_db: The path to the SQLite 3 connectivity database, as generated by
        :py:meth:`metaboblend.databases.create_isomorphism_database`. If None, then the default connectivity database
    ...
    :param return_smi_dict: If True, a dictionary of results is returned, else the function returns None.
    ...
    :return: If `return_smi_dict` is true, returns a dictionary whose keys are SMILEs strings and keys are the number
        of `prescribed_masses` by which the structure was generated.
    """
...
def generate_structures(ms_data: Dict[str, Dict[str, Union[int, list, None]]],
