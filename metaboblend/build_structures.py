...
class ResultsDb:
    ...
    def add_results(self, ms_id_num, smi_dict, fragment_mass=None, fragment_id=None,
        ...
        :param db: The substructure database used to generate results.
...
def generate_structures(ms_data: Dict[str, Dict[str, Union[int, None]]],
    ...
    for i, ms_id in enumerate(ms_data.keys()):
        ...
        results_db.add_results(i, smi_dict, ms_data[ms_id]["prescribed_masses"], None)
        smi_dict = None
...
def substructure_combination_build(substructure_subset, configs_iso, prescribed_structure, isomeric_smiles,
    ...
    for substructure_combination in itertools.product(*substructure_subset):
        ...
        for edges in configs_iso[str(v_a)]:  # build mols for each graph in connectivity db
            ...
            final_substructures = [subs["substructure_id"] for subs in substructure_combination]
