...
class ResultsDb:
    ...
    def __init__(self, path_results_db):
        """Constructor method."""
    ...
    def add_ms(self, msn_data, parameters):
        """
        Add entries to the results table and set up test-specific tables.
        ...
        for ms_id in msn_data.keys():
            ...
            self.cursor.execute("""INSERT INTO results (
                                       ...
                                       str(msn_data[ms_id]["fragment_masses"])
                                   ))

            fragment_statement = "'" + ",\n'".join([str(mass) + "' INTEGER DEFAULT 0" for mass in msn_data[ms_id]["fragment_masses"]])
            self.cursor.execute("""CREATE TABLE {} (
                                       smiles TEXT PRIMARY KEY,
                                       {},
                                       peak_sum INTEGER DEFAULT 0)""".format(ms_id, fragment_statement))
