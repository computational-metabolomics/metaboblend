...
def annotate_msn(ms_data: Dict[str, Dict[str, Union[int, list]]], ppm: int = 5,
    ...
    :param max_atoms_available: The maximal atoms available of substructures to be considered for building molecules.
        atoms_available refers to the number of atoms on a substructre involved in bonding.
...
def build(mc, exact_mass, max_n_substructures, smi_out_path, path_connectivity_db, path_substructure_db,
    ...
    :param path_connectivity_db: The path to the SQLite 3 connectivity database, as generated by
        :py:meth:`metaboblend.databases.create_isomorphism_database`. If None, the default bundled connectivity
    ...
    :param table_name: If specified, the table specified within the substructure database will be used to generate
        molecules; else, a temporary substructure table will be created by the function. Will be removed after
        structures have been built, unless 'clean = False' is set.

    :param clean: Whether to clean the temporary table of substructures, table_name`, after the method is complete.
    """
