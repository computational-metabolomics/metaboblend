/*****************************************************************************
* This is the main header file for gtools.  nauty version 2.5.               *
...
#define SETENV_DEC 0   /* setenv() is declared in stdlib.h */
#define HAVE_PUTENV 1   /* putenv() exists */
#define HAVE_SETENV 0   /* setenv() exists */
...
#define HAVE_SIGPROCMASK 0  /* sigprocmask() exists */
